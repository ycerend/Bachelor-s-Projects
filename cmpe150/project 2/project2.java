...
public class YCD2014400063 {
      ...
      public static final int N=4; //N is the constant ,because in the second problem,there is a constant number that multiplies with digit at the end of each loop.
                                  //And also,N is necessary for the first problem top rint n*n.
      public static final double M=12345678; //M is the constant for second problem, because there must be no previous number m is taken as the previous number.
