          ...
          <div class="box">
            ...
            <div class="box-body no-padding">
              ...
              <thead>
                ...
                <?php
                require_once("db.php");
                if (isset($_GET['id']) && isset($_GET['sota'])) {
                    try {
                
                    $id = $_GET['id'];
                    $sota = $_GET['sota'];
                    $sql2="SELECT * FROM paper_table,topic_paper_table WHERE paper_table.paper_id = topic_paper_table.p_id AND topic_paper_table.t_id='$id'  AND paper_table.paper_result = '$sota'";
                ...
                while($result = $statement2->fetchObject()){ ?>
                    <tr>
                        ...
                        <td><?php
                            $sql2 = "SELECT author_table.author_name, author_surname
                                ...
                                while($result2 = $statement2->fetchObject()){
                                    echo $result2->author_name." ".$result2->author_surname . " <br />"; 
                                }?> </td>
                        <td><?php
                            $sql3 = "SELECT topic_table.topic_name
